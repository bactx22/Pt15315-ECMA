const Blog = {
    ...
    background: url(https://cnet3.cbsistatic.com/img/AXP9ShNeb1zz_QwPqtZf1-JY15k=/1200x630/2020/10/18/bdb7ea97-cb99-48d8-a69c-38d26109f33b/05-iphone-12-pro-2020.jpg);
    https: //cnet3.cbsistatic.com/img/AXP9ShNeb1zz_QwPqtZf1-JY15k=/1200x630/2020/10/18/bdb7ea97-cb99-48d8-a69c-38d26109f33b/05-iphone-12-pro-2020.jpg">
            
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">Iphone 12 Promax</h1>
  ...
  <div class="row">
    <div class="col-md-8">
      <h3 class="pb-4 mb-4 fst-italic border-bottom">
        From the Apple
      </h3><h2 class="blog-post-title">WATCH APPLE’S “HI, SPEED” EVENT LIVE</h2>
        <iframe width="730" height="411" src="https://www.youtube.com/embed/KR0g-1hnQPA" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <div class="col-md-4">
      <div class="p-4 mb-3 bg-light rounded">
        ...
        <p class="mb-0">iPhone 12 Pro and iPhone 12 Pro Max are the smartphone duo of the iPhone line launched by Apple on October 13, 2020, along with the iPhone 12 and iPhone 12 Mini duo. This duo is the successor version of the iPhone 11 Pro and iPhone 11 Pro Max duo with many upgrades. The starting prices for the iPhone 12 Pro and iPhone 12 Pro Max are $ 999 and $ 1099</p>
      </div>
